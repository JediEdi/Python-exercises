...
def valikko():
    ...
    if numerovalinta == ("1"):
        ...
        syotetty_koodi = input ("Lentoaseman ICAO-koodi isoin kirjaimin: ")
        syotetty_nimi = input ("Lentoaseman nimi isolla alkukirjaimella: ")
